...
export function UnassignedPool() {
  ...
  return (
    <div
      ref={setNodeRef}
      className={`bg-white dark:bg-slate-900/60 border-2 rounded-xl p-4 flex flex-col h-full shadow-[0_4px_20px_rgba(0,0,0,0.03)] dark:shadow-2xl transition-all duration-200 ${
        isOver
